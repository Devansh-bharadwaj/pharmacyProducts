        ...
        <div>
          <div className={styles.formMainDiv}>
            <form className={styles.formDiv} onSubmit={loginHandler}>
                ...
                required placeholder="Enter Username" className={styles.userDiv} />
                <input type="password" onChange={passwordChangeHandler}
                required placeholder="Enter Password" className={styles.userDiv} />
                <button type="submit" className={styles.loginDiv}>Login</button>
            </form>
          </div>
        </div>
    </div>
